		...
		writeFileSync(
			...
			[
				...
				entry({
					type: "message",
					id: "4",
					message: { role: "assistant", content: [{ type: "toolCall", id: "t1", name: "subagent_spawn" }] },
				}),
			].join("\n") + "\n",
		);
		...
		writeFileSync(
			...
			[
				...
				entry({
					type: "message",
					id: "1",
					message: { role: "assistant", content: [{ type: "text", text: "odd" }] },
				}),
				entry({
					type: "message",
					id: "2",
					message: { role: "assistant", content: [{ type: "toolCall", id: "t1", name: "bash" }] },
				}),
			].join("\n") + "\n",
		);
