...
Message Markdown uses `heading.html`, `link.html`, `table.html`, and `code-block.html`. Code blocks also include `copy-button.html`. Marked handles ordinary paragraphs, lists, and inline formatting.
